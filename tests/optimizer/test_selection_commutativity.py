...
class TestSelectionCommutativityRule(unittest.TestCase):
    ...
    def test_swap_when_child_more_selective(self):
        ...
        table = QueryTree(type="TABLE", value="T", children=[], parent=None)
        inner = QueryTree(type="SELECTION", value="id = 5", children=[table], parent=None)
        outer = QueryTree(type="SELECTION", value="A != 3", children=[inner], parent=None)
        table.parent = inner
        inner.parent = outer
        ...
        self.assertEqual(inner_after.type, "SELECTION")
        self.assertEqual(inner_after.value, "A != 3")

        self.assertEqual(inner_after.children[0].type, "TABLE")
    ...
    def test_no_swap_when_parent_more_or_equal_selective(self):
        ...
        table = QueryTree(type="TABLE", value="T", children=[], parent=None)
        inner = QueryTree(type="SELECTION", value="A != 3", children=[table], parent=None)
        outer = QueryTree(type="SELECTION", value="id = 5", children=[inner], parent=None)
        table.parent = inner
        inner.parent = outer
    ...
    def test_not_applicable_when_no_nested_selection(self):
        ...
        table = QueryTree(type="TABLE", value="T", children=[], parent=None)
        selection_not_nested = QueryTree(type="SELECTION", value="id = 5", children=[table], parent=None)
